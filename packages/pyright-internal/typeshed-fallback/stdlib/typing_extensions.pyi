...
# Tensor shapes
LiteralInt: _SpecialForm
LiteralIntTuple = tuple[LiteralInt, ...]

# Tuple meta-operators
class TupleBroadcast[S: LiteralIntTuple, N: LiteralIntTuple](LiteralIntTuple): ...
class TupleConcat[S1: LiteralIntTuple, S2: LiteralIntTuple, I: LiteralInt](
    LiteralIntTuple
): ...
class TupleIndex[S: LiteralIntTuple, I: LiteralInt](LiteralInt): ...
class TupleLen[S: LiteralIntTuple](LiteralInt): ...
class TupleMultiIndex[S: LiteralIntTuple, I: tuple[Any, ...]](LiteralIntTuple): ...
class TuplePermute[S1: LiteralIntTuple, S2: LiteralIntTuple](LiteralIntTuple): ...
class TupleReshape[S: LiteralIntTuple, I: LiteralIntTuple](LiteralIntTuple): ...
class TupleSplice[
    S: LiteralIntTuple,
    I1: LiteralInt,
    I2: LiteralInt,
...
class TupleSwap[S: LiteralIntTuple, I1: LiteralInt, I2: LiteralInt](
    LiteralIntTuple
): ...

# Int meta-operators
class IntAdd[A: LiteralInt, B: LiteralInt](LiteralInt): ...
class IntDiv[A: LiteralInt, B: LiteralInt](LiteralInt): ...
class IntMod[A: LiteralInt, B: LiteralInt](LiteralInt): ...
class IntMul[A: LiteralInt, B: LiteralInt](LiteralInt): ...
class IntSub[A: LiteralInt, B: LiteralInt](LiteralInt): ...

class TypeCondition:
    def __bool__(self) -> bool: ...

class IntEq[A: LiteralInt, B: LiteralInt](TypeCondition): ...
class IntNe[A: LiteralInt, B: LiteralInt](TypeCondition): ...
class IntLe[A: LiteralInt, B: LiteralInt](TypeCondition): ...
class IntLt[A: LiteralInt, B: LiteralInt](TypeCondition): ...
class IntGe[A: LiteralInt, B: LiteralInt](TypeCondition): ...
class IntGt[A: LiteralInt, B: LiteralInt](TypeCondition): ...

class Where[T: LiteralInt | LiteralIntTuple | TypeCondition]:
    def __init__(
        self,
        expr: TypeForm[T],
        err: LiteralString | None = None,
    ): ...
