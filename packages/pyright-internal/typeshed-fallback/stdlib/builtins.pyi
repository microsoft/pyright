...
class bytes:
    ...
    def count(
        self, sub: object, start: SupportsIndex | None = ..., end: SupportsIndex | None = ..., /
    ) -> int: ...
...
class list(Generic[_T]):
    ...
    @overload
    def __add__(self, value: list[_T], /) -> Self: ...
    @overload
...
class dict(Generic[_KT, _VT]):
    ...
    @overload
    def setdefault(self: dict[_KT, _T | None], key: _KT, default: None = None, /) -> _T | None: ...
    @overload
...
class set(Generic[_T]):
    ...
    def symmetric_difference(self, s: Iterable[_T], /) -> Self: ...
