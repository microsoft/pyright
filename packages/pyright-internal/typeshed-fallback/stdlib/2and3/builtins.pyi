...
class str(Sequence[str], _str_base):
    ...
    if sys.version_info >= (3,):
        def endswith(
            self, suffix: Union[Text, Tuple[Text, ...]], start: Optional[int] = ..., end: Optional[int] = ...
        ) -> bool: ...
    else:
    ...
    if sys.version_info >= (3,):
        def startswith(
            self, prefix: Union[Text, Tuple[Text, ...]], start: Optional[int] = ..., end: Optional[int] = ...
        ) -> bool: ...
...
if sys.version_info < (3,):
    def apply(
        __func: Callable[..., _T], __args: Optional[Sequence[Any]] = ..., __kwds: Optional[Mapping[str, Any]] = ...
    ) -> _T: ...
...
if sys.version_info >= (3,):
    ...
    def execfile(
        __filename: str, __globals: Optional[Dict[str, Any]] = ..., __locals: Optional[Dict[str, Any]] = ...
    ) -> None: ...
...
if sys.version_info >= (3,):
    ...
    @overload
    def map(
        __func: None, __iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3]
