...
@runtime_checkable
class Sequence(Collection[_T_co], Reversible[_T_co], Protocol[_T_co]):
    @overload
    @abstractmethod
    ...
    # Mixin methods
    def index(self, value: object, start: SupportsIndex = 0, stop: SupportsIndex = ..., /) -> int: ...
...
@runtime_checkable
class AbstractSet(Collection[_T_co], Protocol[_T_co]):
    @abstractmethod
    def __contains__(self, x: object, /) -> bool: ...
    # Mixin methods
    ...
    def __and__(self, other: AbstractSet[object], /) -> AbstractSet[_T_co]: ...
    def __or__(self, other: AbstractSet[_T], /) -> AbstractSet[_T_co | _T]: ...
    def __sub__(self, other: AbstractSet[object], /) -> AbstractSet[_T_co]: ...
...
class MutableSet(AbstractSet[_T], Protocol[_T]):
    ...
    def __iand__(self, it: AbstractSet[object], /) -> typing_extensions.Self: ...
    def __ixor__(self, it: AbstractSet[_T], /) -> typing_extensions.Self: ...
    def __isub__(self, it: AbstractSet[object], /) -> typing_extensions.Self: ...
...
@runtime_checkable
class Mapping(Collection[_KT], Protocol[_KT, _VT_co]):
