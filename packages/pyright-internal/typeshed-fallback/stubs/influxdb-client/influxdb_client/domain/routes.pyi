...
class Routes:
    ...
    def __init__(
        self,
        authorizations: Incomplete | None = ...,
        buckets: Incomplete | None = ...,
        dashboards: Incomplete | None = ...,
        external: Incomplete | None = ...,
        variables: Incomplete | None = ...,
        me: Incomplete | None = ...,
        flags: Incomplete | None = ...,
        orgs: Incomplete | None = ...,
        query: Incomplete | None = ...,
        setup: Incomplete | None = ...,
        signin: Incomplete | None = ...,
        signout: Incomplete | None = ...,
        sources: Incomplete | None = ...,
        system: Incomplete | None = ...,
        tasks: Incomplete | None = ...,
        telegrafs: Incomplete | None = ...,
        users: Incomplete | None = ...,
