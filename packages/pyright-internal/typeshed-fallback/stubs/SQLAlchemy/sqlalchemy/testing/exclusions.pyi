...
class SpecPredicate(Predicate):
    ...
    description: Any
    def __init__(
        self, db, op: Incomplete | None = ..., spec: Incomplete | None = ..., description: Incomplete | None = ...
    ) -> None: ...
    def __call__(self, config): ...
...
class LambdaPredicate(Predicate):
    ...
    description: Any
    def __init__(
        self, lambda_, description: Incomplete | None = ..., args: Incomplete | None = ..., kw: Incomplete | None = ...
    ): ...
    def __call__(self, config): ...
