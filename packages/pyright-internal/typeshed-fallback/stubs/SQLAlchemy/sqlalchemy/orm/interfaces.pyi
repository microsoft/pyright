...
class MapperProperty(HasCacheKey, _MappedAttribute, InspectionAttr, util.MemoizedSlots):
    ...
    def cascade_iterator(self, type_, state, dict_, visited_states, halt_on: Incomplete | None = ...): ...
    parent: Any
...
class PropComparator(operators.ColumnOperators[_T], Generic[_T]):
    ...
    prop: Any
    property: Any
    def __init__(self, prop, parentmapper, adapt_to_entity: Incomplete | None = ...) -> None: ...
...
class UserDefinedOption(ORMOption):
    propagate_to_loaders: bool
    payload: Any
    def __init__(self, payload: Incomplete | None = ...) -> None: ...
