...
def sort_dictionary(d, key: Incomplete | None = None): ...

class OrderedSet(set[_T], Generic[_T]):
    @overload
    def __init__(self, d: None = None) -> None: ...
    @overload
...
def unique_list(seq: Iterable[_T], hashfunc: Callable[[_T], Any] | None = None) -> list[_T]: ...

class UniqueAppender:
    data: Any
    def __init__(self, data, via: Incomplete | None = None) -> None: ...
    def append(self, item) -> None: ...
    def __iter__(self): ...
...
class LRUCache(dict[Any, Any]):
    ...
    threshold: Any
    size_alert: Any
    def __init__(self, capacity: int = 100, threshold: float = 0.5, size_alert: Incomplete | None = None) -> None: ...
