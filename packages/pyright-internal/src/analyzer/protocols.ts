...
export function assignClassToProtocol(
    ...
    if (!enforceInvariance && !treatSourceAsInstantiable) {
        const compatibility = getProtocolCompatibility(destType, srcType, treatSourceAsInstantiable);
    ...
    setProtocolCompatibility(destType, srcType, treatSourceAsInstantiable, isCompatible);
