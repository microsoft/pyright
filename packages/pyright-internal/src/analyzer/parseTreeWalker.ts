...
// Get child nodes of the given node.d.
export function getChildNodes(node: ParseNode): (ParseNode | undefined)[] {
    switch (node.nodeType) {
        ...
        case ParseNodeType.Assignment:
            return [node.d.leftExpr, node.d.rightExpr, node.d.typeAnnotationComment];
        ...
        case ParseNodeType.Call:
            return [node.d.leftExpr, ...node.d.arguments];
        ...
        case ParseNodeType.Index:
            return [node.d.baseExpr, ...node.d.items];
        ...
        case ParseNodeType.Lambda:
            return [...node.d.parameters, node.d.expr];

        case ParseNodeType.List:
            return node.d.entries;

        case ParseNodeType.Match:
            return [node.d.subjectExpr, ...node.d.cases];

        case ParseNodeType.MemberAccess:
            return [node.d.leftExpr, node.d.memberName];
        ...
        case ParseNodeType.Raise:
            return [node.d.typeExpr, node.d.valueExpr, node.d.tracebackExpr];

        case ParseNodeType.Return:
            return [node.d.returnExpr];
        ...
        case ParseNodeType.TypeAlias:
            return [node.d.name, node.d.typeParameters, node.d.expr];

        case ParseNodeType.TypeAnnotation:
            return [node.d.valueExpr, node.d.typeAnnotation];
...
export class ParseTreeVisitor<T> {
    ...
    visitAssignmentExpression(node: AssignmentExprNode) {
        return this._default;
    }
