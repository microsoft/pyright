...
def gradual(
    ...
    mixed: list[tuple[Any, int]],
    callbacks: list[Callable[..., Any]],
) -> None:
    reveal_type(choose(values), expected_text="Literal['array']")
    reveal_type(choose(mixed), expected_text="str")
    reveal_type(choose(callbacks), expected_text="str")
