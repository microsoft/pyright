...
@overload
# This should generate an error because of a partial overlap.
def func31(*args: Any, a: int = ...) -> int: ...
@overload
def func31(*args: Any, a: str = ...) -> str: ...
def func31(*args: Any, a: int | str = 0) -> int | str: ...


type NestedList[V] = V | list[V | NestedList[V]]


@overload
def func32[V](n: list[NestedList[V]]) -> list[V]: ...
@overload
def func32(n: list[NestedList[Any]]) -> list[Any]: ...
...
@overload
def func34(fn: Callable[[], Any]) -> None: ...
@overload
def func34[**P](fn: Callable[P, Any]) -> None: ...
def func34(fn: ...) -> ...: ...


@overload
# This should generate an error because of a partial overlap.
def func35(a: int) -> int: ...
@overload
def func35(*args: int, **kwargs: bool) -> str: ...
def func35(*args: ..., **kwargs: ...) -> ...: ...


@overload
# This should generate an error because of a partial overlap.
def func36(a: int) -> int: ...
@overload
def func36(*args: int, a: bool = ...) -> str: ...
def func36(*args: ..., **kwargs: ...) -> ...: ...


@overload
def func37[V](x: str) -> Callable[[V], list[V]]: ...
@overload
def func37[V](x: Any) -> Callable[[V], V]: ...
def func37(x: ...) -> ...: ...
