...
import { getStringFingerprint, StringFingerprint } from '../common/stringUtils';
...
export class Parser {
    ...
    parseSourceFile(
        ...
        return {
            text: fileContents,
            contentHash: contentHash ?? getStringFingerprint(fileContents),
            parserOutput: {
                parseTree: moduleNode,
