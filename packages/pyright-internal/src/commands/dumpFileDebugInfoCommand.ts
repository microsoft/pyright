...
function getTypeEvaluatorString(
    ...
    function getExpressionNodeWithRange(node: ParseNode, range: TextRange): ExprNode | undefined {
...
class TreeDumper extends ParseTreeWalker {
    ...
    override visitBinaryOperation(node: BinaryOperationNode) {
        this._log(
            `${this._getPrefix(node)} ${getTokenString(
                ...
                this._lines
            )} ${getOperatorTypeString(node.d.operator)}} parenthesized:(${node.d.parenthesized})`
        );
        return true;
    }
    ...
    override visitTuple(node: TupleNode) {
        this._log(`${this._getPrefix(node)} paren:(${node.d.enclosedInParens})`);
        return true;
    }
...
function getErrorExpressionCategoryString(type: ErrorExprCategory) {
    switch (type) {
        ...
        case ErrorExprCategory.MissingCallCloseParen:
            return 'MissingCallCloseParen';
        case ErrorExprCategory.MissingIndexCloseBracket:
            return 'MissingIndexCloseBracket';
        case ErrorExprCategory.MissingMemberAccessName:
            return 'MissingMemberAccessName';
        case ErrorExprCategory.MissingTupleCloseParen:
            return 'MissingTupleCloseParen';
        case ErrorExprCategory.MissingListCloseBracket:
        ...
        case ErrorExprCategory.MissingPatternSubject:
            return 'MissingPatternSubject';
        case ErrorExprCategory.MissingDictValue:
            return 'MissingDictValue';
        case ErrorExprCategory.MaxDepthExceeded:
