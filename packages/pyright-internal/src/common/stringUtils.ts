...
export function getStringFingerprint(contents: string): StringFingerprint {
    let primary = 0;
...
export function areStringFingerprintsEqual(left: StringFingerprint, right: StringFingerprint) {
