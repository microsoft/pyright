...
Pull requests that change analyzer sources run the hosted regression benchmark automatically once.
Maintainers can run it again, or request it for other pull requests, by commenting `/benchmark`. See
