...
If no venvPath is specified, Pyright falls back to the paths found in the PYTHONPATH environment variable. Only directory-based paths are supported (as opposed to zip files or other loader packages). 
