...
class int:
    ...
    def __lt__(self, x: Union[int, float]) -> bool: ...
    def __le__(self, x: Union[int, float]) -> bool: ...
    def __gt__(self, x: Union[int, float]) -> bool: ...
    def __ge__(self, x: Union[int, float]) -> bool: ...
...
class tuple(Sequence[_T_co], Generic[_T_co]):
    ...
    def __add__(self, x: Tuple[...]) -> Tuple[_T_co, ...]: ...
