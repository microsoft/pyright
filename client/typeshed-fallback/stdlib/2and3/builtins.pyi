...
class staticmethod(object):  # Special, only valid as a decorator.
    ...
    def __get__(
        self, obj: _T, type: Optional[Type[_T]] = ...
    ) -> Callable[..., Any]: ...
...
class type(object):
    ...
    @overload
    def __init__(
        self, name: str, bases: Tuple[type, ...], dict: Dict[str, Any]
    ) -> None: ...
    @overload
...
class int:
    @overload
    def __init__(
        self, x: Union[Text, bytes, SupportsInt, _SupportsIndex] = ...
    ) -> None: ...
    @overload
    ...
    if sys.version_info >= (3,):
        def to_bytes(
            self, length: int, byteorder: str, *, signed: bool = ...
        ) -> bytes: ...
        @classmethod
        def from_bytes(
            cls,
...
class float:
    def __init__(
        self, x: Union[SupportsFloat, _SupportsIndex, Text, bytes, bytearray] = ...
    ) -> None: ...
...
if sys.version_info >= (3,):
    ...
    class unicode(basestring, Sequence[unicode]):
        ...
        @overload
        def __init__(
            self, o: str, encoding: unicode = ..., errors: unicode = ...
        ) -> None: ...
        ...
        def endswith(
            self,
            suffix: Union[unicode, Tuple[unicode, ...]],
            start: int = ...,
            end: int = ...,
        ) -> bool: ...
        ...
        def rsplit(
            self, sep: Optional[unicode] = ..., maxsplit: int = ...
        ) -> List[unicode]: ...
        ...
        def startswith(
            self,
            prefix: Union[unicode, Tuple[unicode, ...]],
            start: int = ...,
            end: int = ...,
        ) -> bool: ...
...
class str(Sequence[str], _str_base):
    if sys.version_info >= (3,):
        ...
        @overload
        def __init__(
            self, o: bytes, encoding: str = ..., errors: str = ...
        ) -> None: ...
    else:
        def __init__(self, o: object = ...) -> None: ...
    ...
    def count(
        self, x: Text, __start: Optional[int] = ..., __end: Optional[int] = ...
    ) -> int: ...
    if sys.version_info < (3,):
    ...
    def find(
        self, sub: Text, __start: Optional[int] = ..., __end: Optional[int] = ...
    ) -> int: ...
    ...
    if sys.version_info >= (3,):
        ...
        def replace(
            self, __old: AnyStr, __new: AnyStr, __count: int = ...
        ) -> AnyStr: ...
    if sys.version_info >= (3, 9):
    ...
    if sys.version_info >= (3,):
        ...
        def rsplit(
            self, sep: Optional[str] = ..., maxsplit: int = ...
        ) -> List[str]: ...
    ...
    if sys.version_info >= (3,):
        ...
        def translate(
            self, __table: Optional[AnyStr], deletechars: AnyStr = ...
        ) -> AnyStr: ...
    def upper(self) -> str: ...
    ...
    if sys.version_info >= (3,):
        ...
        @overload
        def maketrans(
            __x: Union[Dict[int, _T], Dict[str, _T], Dict[Union[str, int], _T]]
        ) -> Dict[int, _T]: ...
        @staticmethod
        @overload
        def maketrans(
            __x: str, __y: str, __z: Optional[str] = ...
...
if sys.version_info >= (3,):
    class bytes(ByteString):
        ...
        if sys.version_info >= (3, 8):
            def hex(
                self, sep: Union[str, bytes] = ..., bytes_per_sep: int = ...
            ) -> str: ...
        ...
        def isupper(self) -> bool: ...
        def join(
            self, __iterable_of_bytes: Iterable[Union[ByteString, memoryview]]
        ) -> bytes: ...
        ...
        def rsplit(
            self, sep: Optional[bytes] = ..., maxsplit: int = ...
        ) -> List[bytes]: ...
...
class bytearray(MutableSequence[int], ByteString):
    if sys.version_info >= (3,):
        ...
        @overload
        def __init__(
            self, string: Text, encoding: Text, errors: Text = ...
        ) -> None: ...
        @overload
        def __init__(self, length: int) -> None: ...
    else:
    ...
    if sys.version_info >= (3,):
        def translate(
            self, __table: Optional[bytes], delete: bytes = ...
        ) -> bytearray: ...
    else:
    ...
    if sys.version_info < (3,):
        ...
        def __setslice__(
            self, start: int, stop: int, x: Union[Sequence[int], str]
        ) -> None: ...
...
class memoryview(Sized, Container[_mv_container_type]):
    ...
    if sys.version_info >= (3,):
        ...
        def cast(
            self, format: str, shape: Union[List[int], Tuple[int]] = ...
        ) -> memoryview: ...
    else:
        def __init__(self, obj: ReadableBuffer) -> None: ...
    @overload
...
if sys.version_info < (3,):
    def apply(
        __func: Callable[..., _T],
        __args: Optional[Sequence[Any]] = ...,
        __kwds: Optional[Mapping[str, Any]] = ...,
    ) -> _T: ...
...
def eval(
    __source: Union[Text, bytes, CodeType],
...
if sys.version_info >= (3,):
    @overload
    def filter(
        __function: None, __iterable: Iterable[Optional[_T]]
    ) -> Iterator[_T]: ...
    @overload
    def filter(
...
if sys.version_info >= (3,):
    ...
    @overload
    def map(
        __func: Callable[[_T1, _T2], _S], __iter1: Iterable[_T1], __iter2: Iterable[_T2]
    ) -> Iterator[_S]: ...
    @overload
    def map(
    ...
    @overload
    def map(
        __func: None, __iter1: Iterable[_T1], __iter2: Iterable[_T2]
    ) -> List[Tuple[_T1, _T2]]: ...
    @overload
    def map(
        __func: None,
...
if sys.version_info >= (3,):
    ...
    @overload
    def max(
        __iterable: Iterable[_LT], *, key: None = ..., default: _T
    ) -> Union[_LT, _T]: ...
    @overload
    def max(
        __iterable: Iterable[_T1], *, key: Callable[[_T1], _LT], default: _T2
    ) -> Union[_T1, _T2]: ...

else:
    @overload
    def max(
        __arg1: _T, __arg2: _T, *_args: _T, key: Callable[[_T], Any] = ...
    ) -> _T: ...
    @overload
...
if sys.version_info >= (3,):
    ...
    def open(
        name: Union[unicode, int], mode: unicode = ..., buffering: int = ...
    ) -> BinaryIO: ...
...
if sys.version_info >= (3,):
    ...
    def print(
        *values: object,
        ...
        file: Optional[SupportsWrite[Any]] = ...,
    ) -> None: ...
...
if sys.version_info < (3,):
    def range(
        __x: int, __y: int = ..., __step: int = ...
    ) -> List[int]: ...  # noqa: F811
    def raw_input(__prompt: Any = ...) -> str: ...
    @overload
    def reduce(
        __function: Callable[[_T, _S], _T], __iterable: Iterable[_S], __initializer: _T
    ) -> _T: ...
    @overload
...
if sys.version_info >= (3,):
    @overload
    def sorted(
        __iterable: Iterable[_LT], *, key: None = ..., reverse: bool = ...
    ) -> List[_LT]: ...
    @overload
    def sorted(
...
if sys.version_info < (3,):
    ...
    class buffer(Sized):
        def __init__(
            self, object: _AnyBuffer, offset: int = ..., size: int = ...
        ) -> None: ...
...
class ImportError(_StandardError):
    if sys.version_info >= (3, 3):
        def __init__(
            self, *args: object, name: Optional[str] = ..., path: Optional[str] = ...
        ) -> None: ...
        name: Optional[str]
        path: Optional[str]
...
class UnicodeDecodeError(UnicodeError):
    ...
    reason: str
    def __init__(
        self, __encoding: str, __object: bytes, __start: int, __end: int, __reason: str
    ) -> None: ...
...
class UnicodeEncodeError(UnicodeError):
    ...
    reason: str
    def __init__(
        self, __encoding: str, __object: Text, __start: int, __end: int, __reason: str
    ) -> None: ...
...
if sys.version_info < (3,):
    class file(BinaryIO):
        @overload
        def __init__(
            self, file: str, mode: str = ..., buffering: int = ...
        ) -> None: ...
        @overload
        def __init__(
            self, file: unicode, mode: str = ..., buffering: int = ...
        ) -> None: ...
        @overload
        def __init__(
            self, file: int, mode: str = ..., buffering: int = ...
        ) -> None: ...
        def __iter__(self) -> Iterator[str]: ...
        def next(self) -> str: ...
