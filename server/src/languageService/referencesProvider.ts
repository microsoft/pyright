...
import { LineAndColumn, DocumentLineAndColumnRange } from '../common/textRange';
...
export interface ReferencesResult {
    ...
    locations: DocumentLineAndColumnRange[];
}
...
export class ReferencesProvider {
    static getReferencesForPosition(parseResults: ParseResults, filePath: string,
            position: LineAndColumn, includeDeclaration: boolean,
